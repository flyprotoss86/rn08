...
//public class AgoraCallActivity extends AppCompatActivity {
//
//    @Override
...
public class AgoraCallActivity extends AppCompatActivity implements MainApplication.OnAgoraEngineInterface {
    private final String TAG = AgoraCallActivity.class.getSimpleName();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (i == IAgoraAPI.ECODE_LOGOUT_E_KICKED) { // other login the account
                            Toast.makeText(AgoraCallActivity.this, "Other login account ,you are logout.", Toast.LENGTH_SHORT).show();

                        } else if (i == IAgoraAPI.ECODE_LOGOUT_E_NET) { // net
                            Toast.makeText(AgoraCallActivity.this, "Logout for Network can not be.", Toast.LENGTH_SHORT).show();
                            finish();
                        }
...
//                      "status": 1 // Busy
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (s2.contains("status") && s2.contains("1")) {
                            Toast.makeText(AgoraCallActivity.this, account + " reject your call for busy", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(AgoraCallActivity.this, account + " reject your call", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void initializeAgoraEngine() {
        mAgoraAPI = MainApplication.the().getmAgoraAPI();
        mRtcEngine = MainApplication.the().getmRtcEngine();
    ...
    private void initAgoraEngineAndJoinChannel() {
        ...
        MainApplication.the().setOnAgoraEngineInterface(this);
        setupData();
    }
