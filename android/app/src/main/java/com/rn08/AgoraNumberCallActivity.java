...
//public class AgoraNumberCallActivity extends AppCompatActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_agora_number_call);
//    }
//}
...
public class AgoraNumberCallActivity extends AppCompatActivity {
    private final String TAG = AgoraNumberCallActivity.class.getSimpleName();
        ...
        mAgoraAPI.callbackSet(new AgoraAPI.CallBack() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (i == IAgoraAPI.ECODE_LOGOUT_E_KICKED) { // other login the account
                            Toast.makeText(AgoraNumberCallActivity.this, "Other login account, you are logout.", Toast.LENGTH_SHORT).show();

                        } else if (i == IAgoraAPI.ECODE_LOGOUT_E_NET) { // net
                            Toast.makeText(AgoraNumberCallActivity.this, "Logout for Network can not be.", Toast.LENGTH_SHORT).show();
            ...
            public void onInviteReceived(final String channelID, final String account, int uid, String s2) { //call out other remote receiver
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(AgoraNumberCallActivity.this, AgoraCallActivity.class);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (s.equals("query_user_status")) {
                            Toast.makeText(AgoraNumberCallActivity.this, s1, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (status.equals("1")) {
                            ...
                            Toast.makeText(AgoraNumberCallActivity.this, name + " is offline ", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
