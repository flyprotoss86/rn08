...
//public class AgoraMainActivity extends AppCompatActivity {
//
//    @Override
...
public class AgoraMainActivity extends AppCompatActivity {
    private final String TAG = AgoraMainActivity.class.getSimpleName();
    ...
    public void onClickLogin(View v) {
        ...
        MainApplication.the().getmAgoraAPI().login2(appId, account, "_no_need_token", 0, "", 5, 1);
    }

    private void addCallback() {
        Log.i(TAG, "addCallback enter.");
        MainApplication.the().getmAgoraAPI().callbackSet(new AgoraAPI.CallBack() {
            ...
            public void onLoginSuccess(int i, int i1) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(AgoraMainActivity.this, AgoraNumberCallActivity.class);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (i == IAgoraAPI.ECODE_LOGIN_E_NET) {
                            Toast.makeText(AgoraMainActivity.this, "Login Failed for the network is not available", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
